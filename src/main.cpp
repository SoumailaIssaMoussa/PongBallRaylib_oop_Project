...
float gameDuration = 30.0f;  // Game duration set to 60 seconds
bool isRunning = true;
...
public:
    ...
    // Draw the button 
    void Draw() {
        DrawTextureEx(texture, position, 0.0f, scale, GREEN);
    }
...
int main() {
    ...
    Music music;
    InitAudioDevice();
    music = LoadMusicStream("music/aya.mp3");
    ...
    while (!WindowShouldClose()) {
        ...
        switch (Current_Page) {
            ...
            case WELCOME:
                ...
                DrawTexture(background, screen_width / 2 - background.width / 2, screen_height / 2 - background.height / 2, GREEN);
            ...
            case TIME_OVER:
                ...
                DrawText(TextFormat("SCORE_CPU : %d", cpu_score), 20, 20, 20, GREEN);
                DrawText(TextFormat("SCORE_PLAYER : %d", player_score), 20, 50, 20, GREEN);
                DrawText("COMPUTER_AI", 900, 700, 30, GREEN);
                DrawText("TIME IS FINISH ...!\n\nGAME TIED\n\nDO YOU WANT TO REPLAY?", 460, 50, 30, GREEN);
            ...
            case LOSS:
                ...
                over.draw();
                DrawRectangleRounded(Rectangle{10, 10, 220, 80}, 0.3, 0, { 230, 41, 55, 40 });
                DrawText(TextFormat("SCORE_CPU : %d", cpu_score), 20, 20, 20, Light_Green);
                DrawText(TextFormat("SCORE_PLAYER : %d", player_score), 20, 50, 20, Light_Green);
                DrawText("COMPUTER_AI", 900, 700, 30, Light_Green);
                DrawText("TIME IS FINISH ...!\n\n\nGAME OVER", 460, 30, 50, Light_Green);
                if (exitButton.isPressed(mousePosition, mousePressed)) {
                    CloseWindow();
                    return 0;
                }
            ...
            case WIN:
                ...
                congratulation.draw();
                DrawRectangleRounded(Rectangle{10, 10, 220, 80}, 0.3, 0, { 230, 41, 55, 40 });
                DrawText(TextFormat("SCORE_CPU : %d", cpu_score), 20, 20, 20, RED);
                DrawText(TextFormat("SCORE_PLAYER : %d", player_score), 20, 50, 20, RED);
                DrawText("COMPUTER_AI", 900, 700, 30, Light_Green);
                DrawText("TIME IS FINISH ...!\n\n\nCONGRATULATIONS", 400, 50, 50, RED);
                if (exitButton.isPressed(mousePosition, mousePressed)) {
                    CloseWindow();
                    return 0;
                }
